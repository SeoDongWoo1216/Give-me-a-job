...
- DB 구성([설계서](https://github.com/SeoDongWoo1216/Give-me-a-job/blob/main/%EC%84%A4%EA%B3%84%EC%84%9C/%ED%85%8C%EC%9D%B4%EB%B8%94_%EA%B8%B0%EC%88%A0%EC%84%9C_V1.0.xlsx))  
  - 사람(User, Worker) 테이블   
  - 반려견 테이블   
  - 도그워커 타임 테이블
  - 유저 타임 테이블
